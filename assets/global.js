...
class SliderComponent extends HTMLElement {
  constructor() {
    ...
    this.llySlide = this.querySelectorAll(".lly-small-slide-li");
  ...
  onClickSelecter(e) {
    ...
    if (e.target.className == "lly-small-slide-li") {
      ...
      console.log("🚀 ~ file: global.js ~ line 680 ~ SliderComponent ~ onClickSelecter ~ this.slider.scrollLeft", this.slider.scrollLeft)
      console.log("🚀 ~ file: global.js ~ line 682 ~ SliderComponent ~ onClickSelecter ~ this.sliderLastItem.clientWidth", this.sliderLastItem.clientWidth)
      console.log("🚀 ~ file: global.js ~ line 683 ~ SliderComponent ~ onClickSelecter ~ this.currentPage", this.currentPage)

      const pos =
        this.slider.scrollLeft +
        (index - this.currentPage) * this.sliderLastItem.clientWidth;
